          ...
          <div className="relative z-10 max-w-screen-2xl mx-auto px-8 grid grid-cols-12 gap-8 items-center w-full">
            <div className="col-span-12 lg:col-span-8">
              ...
              <div className="flex gap-4">
                <Link href="/about" className="primary-cta-gradient text-on-primary px-10 py-4 rounded-xl font-headline font-bold text-lg shadow-xl shadow-primary/20 hover:scale-105 transition-transform flex items-center justify-center">
                  Discover Namal
                </Link>
                <Link href="/campus" className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-10 py-4 rounded-xl font-headline font-bold text-lg hover:bg-white/20 transition-all flex items-center justify-center">
                  Virtual Tour
                </Link>
              </div>
            </div>
        ...
        <section className="py-24 max-w-screen-2xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="group cursor-pointer">
              ...
              <Link href="/admissions" className="text-primary font-bold inline-flex items-center group-hover:gap-3 transition-all">Learn More <span className="material-symbols-outlined ml-2">arrow_forward</span></Link>
            </div>
            {/* Academic Programs */}
            <div className="group cursor-pointer">
              <div className="relative overflow-hidden rounded-xl h-[450px] mb-6">
              ...
              <Link href="/academics" className="text-primary font-bold inline-flex items-center group-hover:gap-3 transition-all">Explore Degrees <span className="material-symbols-outlined ml-2">arrow_forward</span></Link>
            </div>
            {/* Campus Life */}
            <div className="group cursor-pointer">
              <div className="relative overflow-hidden rounded-xl h-[450px] mb-6">
              ...
              <Link href="/student-life" className="text-primary font-bold inline-flex items-center group-hover:gap-3 transition-all">See Life at Namal <span className="material-symbols-outlined ml-2">arrow_forward</span></Link>
            </div>
          </div>
        </section>
          ...
          <div className="bg-primary rounded-3xl p-16 relative overflow-hidden">
            ...
            <div className="relative z-10 md:w-3/5">
              ...
              <div className="flex flex-wrap gap-6">
                <Link href="/admissions" className="bg-secondary text-on-secondary px-8 py-4 rounded-xl font-headline font-bold hover:scale-105 transition-transform flex items-center justify-center">Apply for Admission</Link>
                <Link href="/faculty" className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 py-4 rounded-xl font-headline font-bold hover:bg-white/20 transition-all flex items-center justify-center">Contact Faculty</Link>
              </div>
            </div>
          </div>
        </section>
